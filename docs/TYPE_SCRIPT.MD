...
import DeviceHelper = require('@ssets/device/helper');
import ClientHints = require('@ssets/device/client-hints');

/* or */

/*
import * as DeviceDetector from 'node-device-detector';
import * as DeviceHelper from '@ssets/device/helper';
import * as ClientHints from '@ssets/device/client-hints';
